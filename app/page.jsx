...
<button
className={px-4 py-2 text-sm font-medium rounded-t-lg transition-colors ${   activeTab === "main"   ? "bg-gray-800 text-green-400 border-b-2 border-green-400"   : "text-gray-400 hover:text-gray-200"   }}
onClick={() => setActiveTab("main")}
>
Main Trades
</button>
<button
className={px-4 py-2 text-sm font-medium rounded-t-lg transition-colors ${   activeTab === "ai"   ? "bg-gray-800 text-green-400 border-b-2 border-green-400"   : "text-gray-400 hover:text-gray-200"   }}
